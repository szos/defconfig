...
USE DEFSETF: we could use defsetf create a setf-able expander ~customize~ which would allow us to take the object and do things with it using a generic function AND allow us to 
