#+TITLE: DEFCONFIG
*** Status
    [[https://travis-ci.com/szos/defconfig.svg?branch=main]]
    Currently failing on every lisp except SBCL and ABCL. Currently attempting to rewrite test suite to pass with all implementations in .yml file.
* Purpose
